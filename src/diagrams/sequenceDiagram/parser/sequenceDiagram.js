...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[2,2],$V1=[1,5],$V2=[1,7],$V3=[1,8],$V4=[1,12],$V5=[1,13],$V6=[1,14],$V7=[1,15],$V8=[1,17],$V9=[1,18],$Va=[1,7,9,10,17,19,20,21,22,23,24,35],$Vb=[7,9,10,17,19,20,21,22,24,35],$Vc=[1,56];
...
break;
case 9: this.begin('LINE'); return 19; 
break;
case 10: this.begin('LINE'); return 21; 
break;
case 11: this.begin('LINE'); return 22; 
break;
case 12: this.begin('LINE'); return 23; 
break;
